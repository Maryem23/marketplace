...
public class UserDAOImpl implements UserDAO {
	...
	@Override
	public void updateuser(String id,String mail, String nom, String prenom, String contact, String pass) {
		User c=sessionFactory.getCurrentSession().get(User.class, Integer.parseInt(id));
		c.setFirstName(nom);
		c.setEmail(mail);
		c.setContactNumber((contact));
		c.setLastName(prenom);
		c.setConfirmPassword((pass));
		c.setPassword(pass);
