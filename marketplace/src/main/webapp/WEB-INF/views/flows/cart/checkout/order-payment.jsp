	...
	<div class="row">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div>
							...
							<h5>Prix d'achat - DT ${cartLine.buyingPrice}/-</h5>							
						</div>						
						<hr/>
						<div class="text-right">
							<h3>Total - DT ${cartLine.total}/-</h3>
						</div>						
					</div>
					</c:forEach>
				</div>
			...
			<div class="col-md-6">
	            ...
	            <ul class="nav nav-pills nav-stacked">
	                <li class="active"><a href="#"><span class="badge pull-right"> DT ${checkoutModel.checkoutTotal}/-</span>Paiement final</a></li>
	            </ul>
	            <br/>
