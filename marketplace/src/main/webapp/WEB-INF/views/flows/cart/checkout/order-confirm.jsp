...
<title>Shopping en ligne - Adhésion</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
           ...
           <div class="navbar-header">
               <a class="navbar-brand" href="${contextRoot}/home">Shopping en ligne</a>
           </div>
		</div>
	</nav>
	...
	<div class="content">
		<div class="container">
		    ...
		    <div class="row">
		        <div class="col-xs-12">
		    		<div class="invoice-title">
		    			<h2>Reçu</h2><h3 class="pull-right">Commande # ${orderDetail.id}</h3>
		    		</div>
		    		<hr>
		    		<div class="row">
		    			<div class="col-xs-6">
		    				<address>
		    				<strong>Envoyé depuis :</strong><br>
		    	...
		    	<div class="col-md-12">
		    		<div class="panel panel-default">
		    			<div class="panel-heading">
		    				<h3 class="panel-title"><strong>Résumé de commande </strong></h3>
		    			</div>
		    						...
		    						<tbody>
		    							...
		    							<c:forEach items="${orderDetail.orderItems}" var="orderItem">
			    							<tr>
			    								...
			    								<td class="text-center">DT ${orderItem.buyingPrice}</td>
			    								<td class="text-center">${orderItem.productCount}</td>
			    								<td class="text-right">DT ${orderItem.total}</td>
			    							</tr>
		    							</c:forEach>
		    						</tbody>
		    					</table>
		    ...
		    <div class="text-center">
		    	<a href="${contextRoot}/show/all/products" class="btn btn-lg btn-warning">Continuer le shopping</a>
		    </div>
		</div>
