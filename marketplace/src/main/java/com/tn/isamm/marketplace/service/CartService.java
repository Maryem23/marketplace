package com.tn.isamm.marketplace.service;
...
public class CartService {
	...
	public String addCartLine(int productId) {		
		Cart cart = this.getCart();
		System.out.println("this is myy iddddd"+cart.getId());
	...
	private Cart getCart() {
		System.out.println("iddddddddd"+((UserModel)session.getAttribute("userModel")).getCart().getId());
